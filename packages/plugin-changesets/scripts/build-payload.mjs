 ...
 *
 * One root, not two. The resolver reads this package's payload-dist, never payload/, so it
 * never sees a half-built mixture of sources and output.
 */
...
const VERBATIM = ['skills', 'agents', 'kit-templates'];
