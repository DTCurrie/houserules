...
function gatherCommitInfo(fullSha) {
...
function extractBacklogIds(...sources) {
  const ids = new Set();
...
function ensureChangelogHeader(target) {
...
function entryExistsInChangelog(target, shortSha) {
...
function appendEvent(target, record) {
