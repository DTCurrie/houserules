...
function readLastJsonRecord(file) {
  let fd;
  try {
    fd = openSync(file, 'r');
  } catch {
...
function ensureBacklogHeader(file) {
...
function readContentArg(content) {
...
function renderEntry(id, title, body, dateOverride, chat) {
...
function findEntryRange(text, id) {
