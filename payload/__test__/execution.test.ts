...
describe('a CLI-style script outside a git work tree, the earliest failure path there is', () => {
  function runOutsideGitRepo() {
    return spawnSync(process.execPath, [join(SCRIPTS, 'changeset-write.mjs')], {
      cwd: dependencyFreeDir,
      encoding: 'utf8',
    });
  }
